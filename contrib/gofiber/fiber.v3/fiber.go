...
package fiber // import "github.com/DataDog/dd-trace-go/contrib/gofiber/fiber.v3/v2"
...
const componentName = "gofiber/fiber.v3"

var instr *instrumentation.Instrumentation

func init() {
	instr = instrumentation.Load(instrumentation.PackageGoFiberV3)
}
...
func Middleware(opts ...Option) fiber.Handler {
	...
	instr.Logger().Debug("gofiber/fiber.v3: Middleware: %#v", cfg)
